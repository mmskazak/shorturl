...
func (x *HandleCreateShortURLRequest) GetJwt() *wrapperspb.StringValue {
	if x != nil {
		return x.Jwt
	}
	return nil
...
func (x *HandleCreateShortURLRequest) GetOriginalUrl() *wrapperspb.StringValue {
	if x != nil {
...
var file_handle_create_short_url_request_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x01, 0x0a, 0x1b, 0x48, 0x61, 0x6e, 0x64,
	...
	0x75, 0x65, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x12, 0x3f, 0x0a, 0x0c, 0x6f, 0x72, 0x69, 0x67, 0x69,
...
var file_handle_create_short_url_request_proto_depIdxs = []int32{
	1, // 0: HandleCreateShortURLRequest.jwt:type_name -> google.protobuf.StringValue
	1, // 1: HandleCreateShortURLRequest.original_url:type_name -> google.protobuf.StringValue
