...
func (x *SaveShortenURLsBatchResponse) GetJwt() *JWT {
	if x != nil {
		return x.Jwt
	}
	return nil
...
type Output struct {
	...
	ShortUrl      *ShortURL      `protobuf:"bytes,2,opt,name=short_url,json=shortUrl,proto3" json:"short_url,omitempty"`
}
...
func (x *Output) GetCorrelationId() *CorrelationID {
	if x != nil {
...
func (x *Output) GetShortUrl() *ShortURL {
	if x != nil {
		return x.ShortUrl
	}
	return nil
...
var file_save_shorten_url_batch_response_proto_rawDesc = []byte{
	...
	,
	...
	0x0b, 0x32, 0x09, 0x2e, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x55, 0x52, 0x4c, 0x52, 0x08, 0x73, 0x68,
	0x6f, 0x72, 0x74, 0x55, 0x72, 0x6c, 0x42, 0x10, 0x5a, 0x0e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
...
var file_save_shorten_url_batch_response_proto_goTypes = []any{
	...
	(*ShortURL)(nil),                     // 4: ShortURL
}
var file_save_shorten_url_batch_response_proto_depIdxs = []int32{
	1, // 0: SaveShortenURLsBatchResponse.output:type_name -> Output
	2, // 1: SaveShortenURLsBatchResponse.jwt:type_name -> JWT
	3, // 2: Output.correlation_id:type_name -> CorrelationID
	4, // 3: Output.short_url:type_name -> ShortURL
